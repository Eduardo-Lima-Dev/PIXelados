        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center p-8 relative">
          ...
          {isRegistering ? (
            <form onSubmit={registerForm.handleSubmit(onRegister)} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-3 py-2 block w-full rounded-xl border border-gray-700 bg-gray-900 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-10 py-2 block w-full rounded-xl border border-gray-700 bg-gray-900 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
              ...
              <button
                type="submit"
                className="w-full bg-blue-500 text-white py-2 px-4 rounded-xl hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 text-lg font-semibold mt-2"
              >
                Criar Conta
              </button>
            </form>
